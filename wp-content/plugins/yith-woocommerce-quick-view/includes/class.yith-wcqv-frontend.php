	...
	class YITH_WCQV_Frontend {
		...
		public function yith_add_quick_view_button( $product_id = 0, $label = '', $return = false ) {
			...
			if ( $product_id ) {
				...
				$class_shop_page = '';
				if(is_shop()){
					$class_shop_page = 'quick-view-button-shop-page';
				}
				
				$button = '<div class="quick-view-product '.$class_shop_page.'"><div class="quick-view-product-overlay"><a href="#" class="button yith-wcqv-button" data-product_id="' . esc_attr( $product_id ) . '">' . $label . '</a></div></div>';
