	...
	function storefront_credit()
	{
		...
		if ( apply_filters( 'storefront_credit_link', true ) ) {
			if ( storefront_is_woocommerce_activated() ) {
				$links_output .='. Proudly powered by'. '<a href="http://botiga_shop.local/" target="_blank" title="' . esc_attr__( 'Botiga', 'storefront' ) . '" rel="noreferrer">' . esc_html__( ' Botiga', 'storefront' ) . '</a>.';
			} else {
				$links_output .= '. Proudly powered by'.'<a href="http://botiga_shop.local/" target="_blank" title="' . esc_attr__( 'Storefront -  The perfect platform for your next WooCommerce project.', 'storefront' ) . '" rel="noreferrer">' . esc_html__( 'Built with Storefront', 'storefront' ) . '</a>.';
			}
		}
...
if (!function_exists('storefront_primary_navigation')) {
	...
	{
	?>
		<div class="col-md-5 menu-header-top">
...
<?php	}
		...
		if (!function_exists('storefront_header_container')) {
			...
			{
				echo '<div class="col-full site-branding-and-search">';
			}
		}
